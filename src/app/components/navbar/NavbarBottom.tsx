...
export const NavbarBottom = () => (
  <div className="mx-auto w-full container px-8 lg:px-0">
    <div className="bg-white flex rounded-lg items-center justify-between my-6 shadow-lg p- space-x-4 px-4 py-2 text-[1.2rem] border border-gray-200">
      <div>
